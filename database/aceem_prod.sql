...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 25 mai 2020 à 00:03
...
(60, 'status_paiement', 'paiement_complet', 'De la part complet', 'De la part complet', 1),
(61, 'status_paiement', 'paiement_partiel', 'De la part partiel', 'De la part partiel', 1),
...
--
ALTER TABLE `classes`
  MODIFY `classe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `param_divers`
  MODIFY `param_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
