...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 16 mai 2020 à 15:43
...
CREATE TABLE `eleves` (
  ...
  `eleve_lieu_naissance` varchar(100) NOT NULL,
...
INSERT INTO `eleves` (`eleve_id`, `eleve_photo`, `eleve_nom`, `eleve_prenom`, `eleve_adresse`, `eleve_date_naissance`, `eleve_lieu_naissance`, `eleve_matricule`, `eleve_numero`, `eleve_date_inscription`, `eleve_classe_param_fk`, `eleve_classe_cat_param_fk`, `eleve_classe_mention_param_fk`, `eleve_classe_session_param_fk`) VALUES
(4, '-', 'Maheriniaina', 'Michael', 'ss pp', '2020-05-06', '', '215d', 13, '2020-04-30', 35, 52, -1, 3),
(7, '-', 'tes', 'sfs', 'sadac', '2020-05-02', '', '215d2', 3, '2020-05-03', 35, -1, -1, 3);
...
INSERT INTO `paiements` (`paiement_id`, `paiement_montant`, `paiement_eleve_fk`, `paiement_type_paiement_param_fk`, `paiement_mode_paiement_param_fk`, `paiement_commentaire`, `paiement_date_depot`, `paiement_date_maj`) VALUES
(2, 120000, 4, 1, 27, NULL, '2020-05-16 11:53:33', '0000-00-00 00:00:00'),
(3, 60000, 7, 11, 27, NULL, '2020-05-16 14:02:08', '2020-05-16 15:02:08');
...
--
ALTER TABLE `paiements`
  MODIFY `paiement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `param_divers`
--
ALTER TABLE `param_divers`
  MODIFY `param_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
