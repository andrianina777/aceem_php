...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 07 juin 2020 à 14:49
...
--
ALTER TABLE `classes`
  ADD CONSTRAINT `classes_ibfk_1` FOREIGN KEY (`classe_eleve_fk`) REFERENCES `eleves` (`eleve_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `classes_ibfk_2` FOREIGN KEY (`classe_param_fk`) REFERENCES `param_divers` (`param_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `classes_ibfk_3` FOREIGN KEY (`classe_mention_param_fk`) REFERENCES `param_divers` (`param_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `classes_ibfk_4` FOREIGN KEY (`classe_session_param_fk`) REFERENCES `param_divers` (`param_id`) ON DELETE CASCADE ON UPDATE CASCADE;
