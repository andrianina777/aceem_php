...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 26 mai 2020 à 01:03
...
INSERT INTO `classes` (`classe_id`, `classe_categorie`, `classe_param_fk`, `classe_mention_param_fk`, `classe_session_param_fk`, `classe_eleve_fk`) VALUES
(7, 0, 45, 51, 3, 32),
(13, 1, 41, 51, 5, 33),
(30, 0, 62, 49, 3, 31),
(31, 8, 65, 57, 34, 31),
...
INSERT INTO `eleves` (`eleve_id`, `eleve_photo`, `eleve_nom`, `eleve_prenom`, `eleve_adresse`, `eleve_date_naissance`, `eleve_matricule`, `eleve_numero`, `eleve_date_inscription`) VALUES
(1, '-', 'test', 'jon', 'sadac', '2020-05-08', '215d6', 123, '2020-05-07'),
(2, '59a1ecf84a07c961e43f1ff17c12687c.jpg', 'Maheriniaina', 'Michael Jonathan', 'sadac', '2000-05-25', '215d2', 122, '2020-05-20'),
(3, '-', 'test', 'Michael Jonathan', 'adresse be', '2020-05-15', '215d6', 66, '2020-05-13');
...
INSERT INTO `historiques` (`historique_id`, `historique_description`, `historique_utilisateur`, `historique_date`) VALUES
(1, 'Création élèves test', 'admin', '2020-05-26 00:06:11'),
(2, 'Création élèves Maheriniaina', 'admin', '2020-05-26 00:08:20'),
(3, 'Création élèves test', 'admin', '2020-05-26 00:09:24'),
(4, 'Création paiement de 5000', 'admin', '2020-05-26 01:17:21');
...
CREATE TABLE `paiements` (
  ...
  `paiement_numero_recu` int(11) NOT NULL,
  `paiement_date_recu` datetime NOT NULL,
  `paiement_nc` varchar(100) NOT NULL,
...
INSERT INTO `paiements` (`paiement_id`, `paiement_total`, `paiement_montant`, `paiement_numero_recu`, `paiement_date_recu`, `paiement_nc`, `paiement_eleve_fk`, `paiement_num_tranche`, `paiement_status_param_fk`, `paiement_par_param_fk`, `paiement_type_paiement_param_fk`, `paiement_mode_paiement_param_fk`, `paiement_commentaire`, `paiement_date_depot`, `paiement_date_maj`) VALUES
(1, 5000, 5000, 1, '2020-05-13 00:00:00', 'as4', 2, 1, 60, 60, 1, 27, NULL, '2020-05-26 00:17:20', '2020-05-26 01:17:20');
...
--
ALTER TABLE `classes`
  MODIFY `classe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `privileges`
  MODIFY `privilege_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
ALTER TABLE `paiements`
  ...
  ADD CONSTRAINT `paiements_ibfk_2` FOREIGN KEY (`paiement_eleve_fk`) REFERENCES `eleves` (`eleve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
