...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 21 juin 2020 à 23:51
...
CREATE TABLE `eleves` (
  ...
  `eleve_adresse` varchar(100) DEFAULT '-',
  ...
  `eleve_date_limite` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `paiements` (
  ...
  `paiement_recu_fk` int(11) NOT NULL,
...
(1, 'type_paiement', 'ecolage', 's-ecolage', 'Ecolage', 5),
(3, 'categorie_session', 'ss', 'ss', 'SS', 1),
(4, 'categorie_session', 'tms', 'tms', 'TMS', 2),
(5, 'categorie_session', 'am', 'am', 'AM', 3),
(11, 'type_paiement', 'droit', 's-droit', 'Droit', 4),
(13, 'type_paiement', 'bacc', 'bacc', 'BACC', 6),
(14, 'type_paiement', 'bepc', 'bepc', 'BEPC', 7),
(15, 'type_paiement', 'carnet', 'd-carnet', 'CARNET', 9),
(16, 'type_paiement', 'carte', 'd-carte', 'CARTE', 10),
...
CREATE TABLE `recus` (
  ...
  `recu_nom` varchar(100) NOT NULL,
  `recu_type` varchar(20) NOT NULL DEFAULT 'CONFIRMER',
  `recu_date_ajout` datetime DEFAULT NULL,
  `recu_date_changement` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `paiements`
  ...
  ADD KEY `paiement_recu_fk` (`paiement_recu_fk`);
...
--
ALTER TABLE `recus`
  MODIFY `recu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
ALTER TABLE `paiements`
  ...
  ADD CONSTRAINT `paiements_ibfk_5` FOREIGN KEY (`paiement_recu_fk`) REFERENCES `recus` (`recu_id`) ON DELETE CASCADE;
