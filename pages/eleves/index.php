        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-5 form-group">
              <div class="row">
                <div class="col-5"><label for="description">Recherche :</label></div>
                <div class="col-7"><input type="text" id="search" class="form-control form-control-sm" placeholder="NC, matricule, nom, ..."></div>
              </div>
            </div>
            <div class="col-4">
          ...
          <div class="row">
            <div class="offset-3 col-5">
              <div class="row form-group">
                <div class="col-5"><label for="type_recherche">Type de recherche :</label></div>
                <div class="col-7">
          ...
          <div id="filter" class="hidden">
            <div class="offset-3 col-5">
              <div class="row form-group">
                <div class="col-5"><label for="type_eleve">Type d'élève :</label></div>
                <div class="col-7">
                  <select name="type_eleve" class="form-control form-control-sm" id="type_eleve">
            ...
            <div class="offset-3 col-5">
              <div class="row form-group">
                <div class="col-5"><label for="nc">NC :</label></div>
                <div class="col-7"><input type="text" id="nc" class="form-control form-control-sm" placeholder="NC"></div>
              </div>
            </div>
            <div class="row" id="classe_group">
              <div class="offset-3 col-5">
                <div class="row form-group">
                  <div class="col-5"><label for="classe">Classe :</label></div>
                  <div class="col-7">
            ...
            <div class="row" id="mention_group">
              <div class="offset-3 col-5">
                <div class="row form-group">
                  <div class="col-5"><label for="mention">Mention :</label></div>
                  <div class="col-7">
            ...
            <div class="row" id="session_group">
              <div class="offset-3 col-5">
                <div class="row form-group">
                  <div class="col-5"><label for="session">Session :</label></div>
                  <div class="col-7">
...
<script>
  ...
  $('#toggleFilter').click((e) => {
    ...
    if (c === 'Plus de filtre') {
      $('#toggleFilter').html('Moins de filtre');
    } else {
      $('#toggleFilter').html('Plus de filtre');
    }
  });
  ...
  function init_table(url='<?= $base_url ?>/controller/eleves.php?list=0') {
    table = $('#JodataTable').DataTable( {
        ...
        "columns": [
            ...
            { "data": (data, type, full) => {
              return date_formatter(data.eleve_date_limite);
            } },
            {
